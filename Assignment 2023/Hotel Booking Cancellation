...
### Poject Objectives
The aim of the project is to predict whether a booking made in a hotel can be cancelled in future or not. Machine models have been developed for this to help identify and flag bookings with probability of high cancellation rates by analysing the trends and features associated with it. In order to prevent the resulting income losses, hotels can take action on these bookings. With the aid of this form of prediction, hotels can adopt better net demand projections, better overbooking/cancellation policies, and more forceful pricing and inventory allocation tactics. Additionally hotels can use this technique to determine which of their regular clients never cancel their reservations and are eligible for loyalty rewards.

### Data
The dataset used in this report contains 36,275 hotel booking details with 18 corresponding features, including cancellation and non-cancellation status of the booking. Some key variables were selected as the predictor to test and train the prediction model, by applying some machine learning algorithms. After preprocessing the raw data which involves standardising, scaling, checking for missing data and recording some variables was conducted before the prediction.

Data Description
The data contains different attributes of reservation details of customers'. Below is a detailed data dictionary.
...
• arrival_month: Month of arrival date • arrival_date: Date of the month • market_segment_type: Market segment designation.
• repeated_guest: Is the customer a repeated guest? (0 - No, 1- Yes). 
• no_of_previous_cancellations: Number of previous bookings that were canceled by the customer prior to the current booking. 
• no_of_previous_bookings_not_canceled: Number of previous bookings not canceled by the customer prior to the current booking.

### References
Zeytinci, E. (2019, December 30). Predicting Hotel Cancellations with Machine Learning online Antonio, N., Almeida, A. D., & Nunes, L. (2019). Hotel booking demand datasets. Data in Brief, 22, 41–49. doi: 10.1016/j.dib.2018.11.126 Mostipak, J. (2020, February 13). Hotel booking demand online Marcuswingen. (2020, March 6). EDA of bookings and ML to predict cancelations Online

Libraries Used
Python

Python Standard Library: Built in python modules. Numpy: Scientific computing with python. Pandas: Data analysis tools. matplotlib: Static, animated, and interactive visualizations. Seaborn: Python data visualization library.
